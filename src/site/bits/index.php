<?php
	...
	$app['sitenotice'] = array(
		'intro' => 'Blood Frontier is a <a href="/wiki/Collaborate">Free and Open Source</a> game, using <a href="http://libsdl.org/">SDL</a> and <a href="http://opengl.org/">OpenGL</a> which allows it to be ported to many platforms; you can download it for both PC (Windows, Linux, BSD) and Mac. You can <a href="/download">Download a Package</a>, or grab a development copy from our <a href="/wiki/SVN">Subversion</a> repository and live on the bleeding edge.',
