...
VARFP(minfps, 0, 40, 100,				// aim for this fps or higher
...
VARP(autoadjustrate, 0, 100, 10000);	// only adjust this often
VARFP(autoadjustlimit, 0, 30, 100,		// going below this automatically scales to minimum
