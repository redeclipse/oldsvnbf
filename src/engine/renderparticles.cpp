...
static partrenderer *parts[] =
{
    ...
    new softquadrenderer("<grey>particles/smoke", PT_PART|PT_LERP|PT_FLIP|PT_ROT|PT_SHRINK),
    new quadrenderer("<grey>particles/smoke", PT_PART|PT_LERP|PT_FLIP|PT_ROT|PT_SHRINK),
    new softquadrenderer("particles/hint", PT_PART|PT_GLARE|PT_LERP),
    new quadrenderer("particles/hint", PT_PART|PT_GLARE|PT_LERP),
    new softquadrenderer("<grey>particles/smoke", PT_PART|PT_FLIP|PT_ROT|PT_SHRINK),
    ...
    new softquadrenderer("<grey>particles/fire", PT_PART|PT_GLARE|PT_RND4|PT_FLIP|PT_ROT|PT_SHRINK),
    new quadrenderer("<grey>particles/fire", PT_PART|PT_GLARE|PT_RND4|PT_FLIP|PT_ROT|PT_SHRINK),
    new softquadrenderer("<grey>particles/plasma", PT_PART|PT_GLARE|PT_FLIP|PT_ROT|PT_SHRINK),
    new quadrenderer("<grey>particles/plasma", PT_PART|PT_GLARE|PT_FLIP|PT_ROT|PT_SHRINK),
    new softquadrenderer("<grey>particles/electric", PT_PART|PT_GLARE|PT_RND4|PT_FLIP|PT_ROT|PT_SHRINK),
    new quadrenderer("<grey>particles/electric", PT_PART|PT_GLARE|PT_RND4|PT_FLIP|PT_ROT|PT_SHRINK),
    new quadrenderer("<grey>particles/fire", PT_PART|PT_GLARE|PT_FLIP|PT_RND4|PT_GLARE|PT_ROT|PT_SHRINK),
