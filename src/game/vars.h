...
SVARG(mainmaps, "bath bloodgrounds citadel deadsimple deli eight gladiator hollow nova panic refuge rivals smouldering tower warehouse warground venus");
SVARG(ctfmaps, "bath citadel deadsimple deli gladiator hollow refuge nova panic rivals smouldering tower warehouse warground venus");
SVARG(mctfmaps, "deadsimple refuge");
SVARG(stfmaps, "bath bloodgrounds citadel deadsimple deli gladiator hollow nova panic refuge rivals smouldering tower warehouse warground venus");
