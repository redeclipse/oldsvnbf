...
SVARG(mainmaps, "bath citadel deadsimple deli dualstar eight gladiator nova panic refuge rivals smouldering tower warehouse warground venus");
...
SVARG(stfmaps, "bath citadel deadsimple deli dualstar gladiator nova panic refuge rivals smouldering tower warehouse warground venus");
