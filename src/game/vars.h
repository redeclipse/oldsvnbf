...
SVARG(mainmaps, "bath bloodgrounds chaos citadel deadsimple deli eight enigma forge gladiator hollow nova panic refuge rivals smouldering tower tranquility warehouse warground venus");
SVARG(ctfmaps, "bath bloodgrounds chaos citadel deadsimple deli enigma forge gladiator hollow refuge nova panic rivals smouldering tower tranquility warehouse warground venus");
SVARG(mctfmaps, "bloodgrounds deadsimple enigma refuge");
SVARG(stfmaps, "bath bloodgrounds chaos citadel deadsimple deli enigma forge gladiator hollow nova panic refuge rivals smouldering tower tranquility warehouse warground venus");
