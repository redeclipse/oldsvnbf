...
SVARG(lobbymaps, "eight citadel dualstar gladiator nova panic refuge rivals smouldering tower warehouse warground vertigo overseer 4square siege exoticbase");
SVARG(missionmaps, "mpspbf1 mpspbf2");
SVARG(mainmaps, "eight citadel dualstar gladiator nova panic refuge rivals smouldering tower warehouse warground vertigo");
SVARG(ctfmaps, "citadel dualstar gladiator refuge nova panic rivals smouldering tower warehouse warground");
SVARG(mctfmaps, "refuge");
SVARG(stfmaps, "citadel dualstar gladiator nova panic refuge rivals smouldering tower warehouse warground vertigo");
