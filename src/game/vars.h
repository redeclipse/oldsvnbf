...
GSVAR(IDF_ADMIN, ctfmaps, "bath citadel darkness deadsimple deli enigma forge ghost gladiator nova panic refuge rivals smouldering warground venus");
GSVAR(IDF_ADMIN, mctfmaps, "deadsimple enigma ghost refuge");
GSVAR(IDF_ADMIN, stfmaps, "bath bloodgrounds citadel darkness deadsimple deli enigma forge ghost gladiator nova panic refuge rivals smouldering tower warground venus");
