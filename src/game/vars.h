...
GVAR(0, spawnweapon, WEAP_MELEE, WEAP_PISTOL, WEAP_MAX-1);
GVAR(0, instaweapon, WEAP_MELEE, WEAP_RIFLE, WEAP_MAX-1);
GVAR(0, limitedweapon, WEAP_MELEE, WEAP_MELEE, WEAP_MAX-1);
