...
enum
{
	...
	S_ITEMPICKUP, S_ITEMSPAWN, S_REGEN, S_DAMAGE1, S_DAMAGE2, S_DAMAGE3, S_DAMAGE4, S_DAMAGE5, S_DAMAGE6, S_DAMAGE7, S_DAMAGE8, S_RESPAWN, S_CHAT, S_ERROR, S_ALARM,
	S_V_FLAGSECURED, S_V_FLAGOVERTHROWN, S_V_FLAGPICKUP, S_V_FLAGDROP, S_V_FLAGRETURN, S_V_FLAGSCORE, S_V_FLAGRESET, S_V_FIGHT, S_V_CHECKPOINT, S_V_ONEMINUTE,
	S_V_HEADSHOT, S_V_SPREE1, S_V_SPREE2, S_V_SPREE3, S_V_SPREE4, S_V_SPREE5, S_V_SPREE6, S_V_MKILL1, S_V_MKILL2, S_V_MKILL3,
...
struct weaptypes
{
	int	info, 				anim,				colour,			sound, 		esound, 	fsound,		rsound,
			...
			collide[2];
	bool	radial[2],			taper[2],		extinguish[2],			burns[2],			reloads,	zooms,	fullauto[2],		thrown[2];
...
weaptypes weaptype[WEAP_MAX] =
{
	...
	},
	{
		WEAP_SMG,			ANIM_SMG,			0xFF8822,		S_SMG,		S_BZAP,		S_WHIZZ,	S_RICOCHET,
			...
			{ 0.5f, 3 },		{ 100, 120 },		{ 512, 384 },		5,
			"smg",		"\fo",	"weapons/smg/item",			"weapons/smg/vwep",			""
	},
	{
		WEAP_FLAMER,		ANIM_FLAMER,		0xFF2222,		S_FLAMER,	S_BURN,		S_BURNING,	-1,
			50,		50,		{ 1, 5 },	{ 100, 750 }, 	2000,	{ 5, 5 },		{ 150, 250 },		0,			{ 350, 700 },
			0,		{ 28, 32 },	{ 1, 5 },		{ 40, 10 },		{ 2, 2 },
			{ BOUNCE_GEOM|IMPACT_PLAYER, IMPACT_GEOM|IMPACT_PLAYER|COLLIDE_OWNER },
			{ true, true },		{ false, false },	{ true, true },		{ true, true, },	true,		false,	{ true, true },		{ false, false },
			{ 0.15f, 0.f },		{ 45, 0 },			{ 0.75f, 0.5f },	{ 1, 1 },		{ -300, 75 },		{ 30, 32 },			{ 0, 0 },
	...
	},
	{
		WEAP_PLASMA,		ANIM_PLASMA,		0x22FFFF,		S_PLASMA,	S_ENERGY,	S_HUM,		-1,
			...
			0,		{ 24, 48 },	{ 1, 1 },		{ 5, 5 },		{ 0, 0 },
			{ IMPACT_GEOM|IMPACT_PLAYER, IMPACT_GEOM|COLLIDE_STICK },
			{ true, true },		{ true, true },		{ true, false },	{ false, false, },	true,		false,	{ true, true },		{ false, false },
	...
	},
	{
		WEAP_GRENADE,		ANIM_GRENADE,		0x22FF22,		S_GRENADE,	S_EXPLODE,	S_BEEP,	S_TINK,
			...
			{ BOUNCE_GEOM|BOUNCE_PLAYER|COLLIDE_OWNER, IMPACT_GEOM|COLLIDE_STICK },
