...
namespace ctf
{
    ...
    void render()
    {
        loopv(st.flags)
        {
            ...
            rendermodel(NULL, flagname, ANIM_MAPMODEL|ANIM_LOOP, above, !f.droptime ? f.ent->attr[2] : f.interptime%360, !f.droptime ? f.ent->attr[3] : 0, 0, MDL_DYNSHADOW | MDL_CULL_VFC | MDL_CULL_OCCLUDED | MDL_LIGHT, NULL, NULL, 0, 0, trans);
