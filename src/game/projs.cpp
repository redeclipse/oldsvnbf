			...
			switch(proj.weap)
			{
				...
				case WEAPON_FLAMER:
				{
					...
					if(proj.canrender)
					{
						...
						if(flamertrails && lastmillis-proj.lasteffect > flamertraildelay)
						{
							effect = true;
			...
			case PRJ_SHOT:
			{
				...
				switch(proj.weap)
				{
					...
					{ // both basically explosions
						...
						adddynlight(proj.o, 1.1f*weaptype[proj.weap].explode, vec(1.1f, 0.22f, 0.02f), proj.weap == WEAPON_FLAMER ? 250 : 1250, 10);
