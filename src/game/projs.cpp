			...
			case PRJ_SHOT:
			{
				...
				switch(proj.weap)
				{
					case WEAPON_PLASMA:
					{
						...
						part_create(PART_SMOKE_RISE_SLOW, m_speedtimex(250), proj.o, 0x8899AA, 2.4f);
					...
					case WEAPON_CARBINE:
					{
						...
						part_create(PART_SMOKE_RISE_SLOW, m_speedtimex(200), proj.o, 0x999999, weaptype[proj.weap].partsize);
