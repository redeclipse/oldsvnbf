...
#ifdef BFRONTIER
    tident(int t, char *n, char *narg, void *f = NULL, T *_s = NULL, bool _srv = false)
        : _type(t), _name(n), _server(_srv), _fun((void (__cdecl *)(void))f), _narg(narg), self(_s) {}
#else
